...
assert(code.includes('Public UI Clarity Pass'), 'BUILD name should identify the local sample check');
assert(code.includes('v3.19.1 Public UI Clarity Pass'), 'roadmap should include v3.19 layer');
...
assert(code.includes('PROXUMA_IT_v3.19.1_PUBLIC_UI_CHECKLIST.txt'), 'checklist download filename should identify v3.19');
...
assert(fs.existsSync(path.join(root, 'NEXT_CHAT_HANDOFF_PROXUMA_IT_v3.19.1.md')), 'current handoff should be present');
...
assert(checklist.includes('Proxuma IT v3.19.1 Public UI Clarity Pass'), 'checklist should identify v3.19.1 public UI clarity pass');
assert(deployInfo.includes('v3.19.1 Public UI clarity pass active'), 'deploy info should identify v3.19.1 public UI clarity pass');
...
console.log('PASS: v3.19.1 Public UI Clarity Pass verified: clean package, offline guarantees, and v3.15.1 red-team hardening preserved.');
