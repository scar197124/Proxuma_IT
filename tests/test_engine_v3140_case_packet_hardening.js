...
assert(/version: \"v3\.(14|15|16|17|18|19)\.[01]\"/.test(code), 'BUILD version should be v3.14.0 or newer continuity build');
assert(code.includes('Evidence Case Packet Hardening / Offline Export Envelope') || code.includes('Browser / Deployment Test Lock') || code.includes('Red Team Hardening Pass') || code.includes('Public UI Clarity Pass'), 'BUILD name should describe current continuity layer');
