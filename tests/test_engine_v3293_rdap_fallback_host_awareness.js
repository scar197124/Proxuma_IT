...
assert(js.includes('name: "RDAP Fallback + Host Awareness Polish"'), 'Build name should identify RDAP fallback/host awareness');
...
console.log('v3.29.3 RDAP fallback + host awareness tests passed');
